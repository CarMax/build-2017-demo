...
Param(
    [string] [Parameter(Mandatory=$true)] $DemoName,
	[string] $ResourceGroupLocation = "Central US",
    [string] $ResourceGroupName = "kmx-$DemoName-central-shared",
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'Templates\azuredeploy.json',
    [string] $TemplateParametersFile = "Templates\$DemoName-central.parameters.json",
